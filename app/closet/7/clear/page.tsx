...
import { Volume2, VolumeX, Home, Trophy, ArrowRight, BookOpen, Star, Ruler } from "lucide-react"
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              >
                ...
                <div className="mr-2 sm:mr-3">
                  <Ruler className="h-6 w-6 sm:h-8 sm:w-8 text-yellow-300" />
                </div>
                <div className="flex-1">
                  <p className="text-yellow-300 font-bold text-sm sm:text-base">空間測定のルーン</p>
                  <p className="text-white text-xs sm:text-sm">空間を正確に測定し、最適な収納方法を導き出す古代の魔法</p>
                </div>
                <Button
