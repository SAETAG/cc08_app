...
import { Volume2, VolumeX, Home, Trophy, ArrowRight, Compass, Star, BookOpen } from "lucide-react"
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              >
                ...
                <div className="mr-2 sm:mr-3">
                  <BookOpen className="h-6 w-6 sm:h-8 sm:w-8 text-yellow-300" />
                </div>
                <div className="flex-1">
                  <p className="text-yellow-300 font-bold text-sm sm:text-base">整理の預言書</p>
                  <p className="text-white text-xs sm:text-sm">未来の混沌を予測し、今すべき整理法を教えてくれる神秘の書</p>
                </div>
                <Button
