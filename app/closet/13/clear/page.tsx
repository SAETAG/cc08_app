            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              >
                ...
                <div className="mr-2 sm:mr-3">
                  <Scan className="h-6 w-6 sm:h-8 sm:w-8 text-yellow-300" />
                </div>
                <div className="flex-1">
                  <p className="text-yellow-300 font-bold text-sm sm:text-base">輝きの鏡・真実</p>
                  <p className="text-white text-xs sm:text-sm">整理された空間の美しさを映し出し、その状態を維持する力を与える鏡</p>
                </div>
                <Button
